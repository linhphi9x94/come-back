...
# ---------
# VARIABLES
# exynos8890-gracelte_kor_all_01 exynos8890-gracelte_kor_all_02 exynos8890-gracelte_kor_all_03 exynos8890-gracelte_kor_all_05 exynos8890-gracelte_kor_all_07 exynos8890-gracelte_kor_all_09 exynos8890-gracelte_kor_all_11 exynos8890-gracelte_kor_all_12
# ---------
BUILD_SCRIPT=3.00
...
hero2lte)
	...
	;;
gracelte)
		DTSFILES="exynos8890-gracelte_kor_all_01 exynos8890-gracelte_kor_all_02 exynos8890-gracelte_kor_all_03 exynos8890-gracelte_kor_all_05 exynos8890-gracelte_kor_all_07 exynos8890-gracelte_kor_all_09 exynos8890-gracelte_kor_all_11 exynos8890-gracelte_kor_all_12"
		;;
*)
...
case $MODEL in
gracelte)
	sed -i -- 's/G935/N930/g' $RDIR/.work/ramdisk/ramdisk/default.prop
...
[ -f "$RDIR/.work_zip/base/boot.img" ] && zip -gq $ZIP_NAME boot.img -x "*~"
[ -f "$RDIR/.work_zip/base/n930x.img" ] && zip -gq $ZIP_NAME n930x.img -x "*~"
...
mv -f $RDIR/output/build.log $RDIR/output/build-n930f.log
END_TIME=`date +%s`
...
echo "You can now find your build-n930f.log file in the output folder"
echo ""
exit
}
...
mv -f $RDIR/.work/ramdisk/image-new.img $RDIR/output/n930f.img
mv -f $RDIR/output/build.log $RDIR/output/build-n930f.log
MODEL=hero2lte
KERNEL_DEFCONFIG=$KERNELCONFIG-hero2lte_defconfig
	(
...
echo "Total compiling time is $ELAPSED_TIME seconds"
echo ""
echo "You can now find your n930f.img in the output folder"
...
cp -rf $RDIR/build/zip/n930x/* $RDIR/.work_zip/base
MODEL=gracelte
KERNEL_DEFCONFIG=$KERNELCONFIG-gracelte_defconfig
START_TIME=`date +%s`
	(
...
mv -f $RDIR/output/build.log $RDIR/output/build-n930f.log
ZIP_DATE=`date +%Y%m%d`
ZIP_NAME=$KERNELNAME.N930x.NFE.v$VERSION_NUMBER.$ZIP_DATE.zip
...
mv -f $RDIR/.work/ramdisk/image-new.img $RDIR/.work_zip/base/n930x.img
mv -f $RDIR/output/build.log $RDIR/output/build-n930f.log
MODEL=hero2lte
KERNEL_DEFCONFIG=$KERNELCONFIG-hero2lte_defconfig
	(
